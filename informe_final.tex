...
\begin{titlepage}
    ...
    {\Large\bfseries INFORME FINAL DE PROYECTO \par}
    \vspace{0.4cm}
    {\huge\bfseries HELICOPTER ATTACK 3D \par}
    \vspace{0.3cm}
    {\small Videojuego de Combate Táctico con Visión Nocturna CCTV y Sistema de Oleadas en Unity \par}
    
    \vspace{1.5cm}
    
    \begin{flushleft}
        \textbf{CURSO:} Computación Gráfica, Visión Computacional y Multimedia \\[0.2cm]
        \textbf{DOCENTE:} Mag. Rene Alonso Nieto Valencia \\[0.2cm]
        \textbf{ESTUDIANTE:} Kevin Joel Callo Ccagiavilca \\[0.2cm]
        \textbf{REPOSITORIO GITHUB:} \url{https://github.com/KevinCallo/TrabajoFinalCGVCYM.git}
    \end{flushleft}
...
\begin{itemize}
    ...
    \item \textbf{Aplicación Compilada Executable (.exe para Windows):} \\
